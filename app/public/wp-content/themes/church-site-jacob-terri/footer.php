        ...
        <div>
          ...
          <ul class="space-y-2">
            <li class="flex items-start">
              ...
              <a href="mailto:contact@clubname.com" class="text-[#F5E9D7] hover:text-[#C9A66B] transition duration-300">contact@muyi-bilengual.com</a>
            </li>
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 text-[#C9A66B]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
              </svg>
              <a href="tel:1234567890" class="text-[#F5E9D7] hover:text-[#C9A66B] transition duration-300">(123) 456-7890</a>
            </li>
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 text-[#C9A66B]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="text-[#F5E9D7]">Taichung, Taiwan</span>
            </li>
          </ul>
        </div>
...
Muyi Bilingual Congregation 慕義堂雙語崇拜. All rights reserved.
      ...
      <div class="flex space-x-6 mt-4 md:mt-0">
        <a href="#" class="text-[#F5E9D7] hover:text-[#C9A66B] transition duration-300">
