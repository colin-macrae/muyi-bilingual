<?php get_header(); ?>
    <div className="w-full text-center sm:mx-16">
        ...
        <section class="max-w-5xl mx-auto px-4 pt-24 pb-32 text-center">
            ...
            <div class="animate-on-scroll flex flex-col md:flex-row gap-8 text-xl">
        ...
        <section class="bg-[#A3B899] px-12  pt-24 pb-32 text-center">
            <div class=" animate-on-scroll mb-4">
                    <h2 class="text-3xl font-bold mb-12">About Us | <span class="text-2xl md:text-3xl">
                        關於我們
                    </span>
                </h2>
            </div>
            <div class=" animate-on-scroll flex flex-col gap-8 justify-center max-w-[1000px] mx-auto text-xl">
                <div>
